...
if __name__ == "__main__":
    ...
    # Somehow LLMChain does not support Transformers pipeline. Hence, we directly used Transformers pipeline in "ice_local_model_transf_only.py"
   ...
   # hfgppl = HuggingFacePipeline( model=model )
