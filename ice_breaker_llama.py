...
# We have used the model from Hugging Face
...
# Utilize PromptTemplate to structure your summarization process and LLMChain to seamlessly connect Langchain with your pipeline. 
...
###################################################################################
# Following is the result of the Run
###################################################################################
# * Patient presents with complaints of persistent fatigue, unexplained weight loss, and intermittent abdominal pain.
#             * Medical history includes hypertension, appendectomy, and hernia repair surgery.
#             * Review of systems reveals fatigue, weight loss, abdominal pain, and nausea.
#             * Physical examination reveals tenderness in the right upper quadrant of the abdomen.
#             * Diagnostic investigations include complete blood count, comprehensive metabolic panel, liver function tests, abdominal ultrasound, and CT scan of the abdomen.
#             * Assessment and plan include further evaluation by a gastroenterologist, oncology consultation, symptom management, nutritional support, psychological support, and follow-up appointment.
#             * Prognosis will depend on the nature of the liver mass and the success of treatment interventions.
...
#             * The healthcare team will collaborate closely to guide the patient's management and optimize his chances of recovery.